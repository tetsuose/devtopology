...
This document describes the contract system used by repo-guardrails to track file purpose, invariants, and verification across a repository.
...
All settings live in `guardrails.yaml`:
